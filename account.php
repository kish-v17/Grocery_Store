...
<div class="container ">
    <div class=" d-flex justify-content-between sitemap mt-5">
        ...
        <p>Welcome! <span class="highlight"><?php echo $user['First_Name'] . " " . $user['Last_Name'];; ?></span></p>
    </div>
</div>
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-md-9 p-2">
            <div class="shadow-sm p-4">
                <div id="my-profile" class="invisible">
                    ...
                    <form class="edit-profile form" method="post" onsubmit="return validateMyAccountForm();">
                        <div class="row g-2">
                            <div class="col-12 col-sm-6">
                                <label for="" class="form-label">First Name</label>
                                <input type="text" class="w-100" placeholder="First Name*" name="ufname" id="firstName" value="<?php echo $user['First_Name']; ?>">
                                <p id="firstNameError" class="error"></p>
                            </div>
                            <div class="col-12 col-sm-6">
                                <label for="" class="form-label">Last Name</label>
                                <input type="text" class="w-100" placeholder="Last name*" name="ulname" id="lastName" value="<?php echo $user['Last_Name']; ?>">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" class="w-100" placeholder="Your Phone*" name="uphone" id="phone" value="<?php echo $user['Mobile_No']; ?>">
                                <p id="phoneError" class="error"></p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <input type="submit" name="btnUpdate" value="Update Profile" class="btn-msg mt-2 ">
                        </div>
                    </form>

                    <form class="edit-profile form" method="post" onsubmit="return validateChangePassword();">
                        <div class="row g-2">
                            <div class="col-12">
                                <label for="" class="form-label d-block">Password</label>
                                <input type="text" class="w-100 mb-2" name="current" placeholder="Current password" id="currentPassword">
                                ...
                                <input type="text" class="w-100 mb-2" name="confirm" placeholder="Confirm password" id="confirmPassword">
