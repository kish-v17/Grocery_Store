            ...
            <div class="card-body">
                <form action="orders.php" method="POST" onsubmit="return validateAddOrderForm()">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="orderDate" name="orderDate" value="2024-08-18">
                        ...
                        <div class="product-entry mb-3">
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="productId1" name="products[0][productId]" value="101">
                                    <div id="productId1Error" class="error-message"></div>
                                </div>
                                <div class="col-md-5">
                                    <label for="quantity1" class="form-label">Quantity</label>
                                    <input type="number" class="form-control" id="quantity1" name="products[0][quantity]" min="1" value="2">
                    ...
                    <div class="mb-3 mt-4">
                        ...
                        <textarea class="form-control" id="shippingAddress" name="shippingAddress" rows="3">123 Main St, Apt 4B, Cityville</textarea>
                        <div id="shippingAddressError" class="error-message"></div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="billingAddress" class="form-label">Billing Address</label>
                        <textarea class="form-control" id="billingAddress" name="billingAddress" rows="3">123 Main St, Apt 4B, Cityville</textarea>
