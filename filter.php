    ...
    <div class="invisible  border p-3 row" id="filter-section">
        ...
        <div class="col-6 col-sm-4 col-md-3 invisible mb-2">
            ...
            <div>
                <div class="text-nowrap">
                    <input type="checkbox" name="lt50" id="lt50">
                    <label for="lt50">Less than Rs 50</label>
                </div>
                <div class="text-nowrap">
                    <input type="checkbox" name="51to100" id="51to100">
                ...
                <div class="text-nowrap">
                    <input type="checkbox" name="201to500" id="201to500">
                    <label for="201to500">Rs 201 to 500</label>
                </div>
                <div class="text-nowrap">
                    <input type="checkbox" name="gt500" id="gt500">
        ...
        <div class="col-6 col-sm-4 col-md-3 invisible mb-2">
            <h6 class="mb-2"><span>Category</span></h6>
            <div>
                <div class="text-nowrap">
